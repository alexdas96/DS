...
void encryption_method(void)
{
        ...
        for(i=0, j=0; i<strlen(key); ++i)
        {
            ...
            {
                printf("The password you have entered contains characters that are not allowed. Please enter alphabet letters only.\n");
        ...
        printf("\nThe plain text is: %s\n", str);
        printf("The encryption password is: %s\n", key);
...
void decryption_method(void)
{
        ...
        lennumstr=i;
        loop_decryption_key:
        printf("\nPlease enter a decryption password: ");
        scanf(" %s", key);
        for(i=0, j=0; i<strlen(key); ++i)
        {
            if(isalpha(key[i])==false)
        ...
        printf("The decryption password is: %s\n", key);
